    ...
    <section className="rounded-xl overflow-hidden border border-slate-800 bg-black">
      <div className="px-6 py-5 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="min-w-0">
          ...
          <h3 className="text-sm font-bold text-white leading-tight whitespace-nowrap">Confirm &amp; Generate Deployment Order</h3>
          {!hasWorkPlan && (
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button
            disabled={!hasWorkPlan}
            className="bg-white text-black px-5 py-2 rounded-lg text-xs font-black flex items-center gap-1.5 hover:bg-slate-100 active:scale-[0.98] transition-all disabled:opacity-30 disabled:cursor-not-allowed whitespace-nowrap shadow-sm"
          >
            Confirm &amp; Generate DO
